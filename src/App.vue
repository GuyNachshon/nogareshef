...
const portfolioItems = [
    {
        media: [
            { type: "image", src: "src/assets/work/AmirBuilding/poster1.jpg" },
            { type: "image", src: "src/assets/work/AmirBuilding/poster2.jpg" },
            { type: "video", src: "src/assets/work/AmirBuilding/motion.mp4" }
        ],
        mediaLayout: [
            { type: "row", items: [0, 1] },
            { type: "single", items: [2] }
    ...
    {
        "media": [
            { "type": "image", "src": "src/assets/work/neighbours/1.jpg" },
            { "type": "image", "src": "src/assets/work/neighbours/2.jpg" },
            { "type": "image", "src": "src/assets/work/neighbours/3.jpg" }
        ],
        mediaLayout: [
            { type: "single", items: [0] },
            { type: "row", items: [1, 2] },
    ...
    },
    {
        "media": [
            {
                "type": "image",
                "src": "src/assets/work/expressions/trio.jpg",
            },
    ...
    },
    {
        "media": [
            {
                "type": "image",
                "src": "src/assets/work/drawings/animal.png"
            },
    ...
    },
    {
        "media": [
            ...
            {
                "type": "video",
                "src": "src/assets/work/joint/free-kick.mp4"
            }
        ],
